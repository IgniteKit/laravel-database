...
namespace IgniteKit\Backports\Database\Schema;
...
use IgniteKit\Backports\Database\SQLiteConnection;
use IgniteKit\Backports\Database\Schema\Grammars\Grammar;
...
class Blueprint
{
     ...
     *
     * @var \IgniteKit\Backports\Database\Schema\ColumnDefinition[]
     */
    protected $columns = [];
     ...
     *
     * @var \IgniteKit\Backports\Support\Fluent[]
     */
    protected $commands = [];
     ...
     *
     * @return \IgniteKit\Backports\Support\Fluent
     */
     ...
     * @param  string|array  $columns
     * @param  string|null  $name
     * @return \IgniteKit\Backports\Support\Fluent|\IgniteKit\Backports\Database\Schema\ForeignKeyDefinition
     */
     ...
     *
     * @param  string  $column
     * @return \IgniteKit\Backports\Database\Schema\ColumnDefinition
     */
