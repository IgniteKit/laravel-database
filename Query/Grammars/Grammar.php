...
namespace IgniteKit\Backports\Database\Query\Grammars;

use RuntimeException;
use IgniteKit\Backports\Support\Arr;
use IgniteKit\Backports\Support\Str;
use IgniteKit\Backports\Database\Query\Builder;
use IgniteKit\Backports\Database\Query\JoinClause;
use IgniteKit\Backports\Database\Grammar as BaseGrammar;
...
class Grammar extends BaseGrammar
{
     ...
     *
     * @param  \IgniteKit\Backports\Database\Query\Expression|string  $value
